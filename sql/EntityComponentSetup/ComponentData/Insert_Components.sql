...
('DialogueState', 'Prompt and responses for this entity','ComponentData_DialogueState'),
...
('RoomSlot', 'Something that could be in a room','ComponentData_RoomSlot'),
('RoomSlotList', 'List of rooms','ComponentData_RoomSlotList'),
...
('TransitionList', 'List of transitions','ComponentData_TransitionList'),
